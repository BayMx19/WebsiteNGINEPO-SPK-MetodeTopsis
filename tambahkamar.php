...
<div class="content-wrapper">
        <div class="container">
              <div class="row">
                    ...
                    <h1 class="mt-5">Tambah Kamar Hotel</h1>
                        ...
                        <div class="panel-body">
                            ...
                            <form action="" method="post" enctype="multipart/form-data">
                                          <div class="form-group">
                                            ...
                                            <option value=0 selected>- Pilih Pemilik Hotel  -</option>";
                                          ...
                                          <div class="form-group">
                                            <label>Jarak Kos Dari Kampus Ke Tempat Hotel.Contoh:Jika 1KM Tulis:1000</label>
