...
<div class="container">
      <div class="row">
        <div class="col-lg-12">
                                        ...
                                        <h1 class="mt-5">TOP RANGKING Hotel TERBAIK</h1>
                                    ...
                                    for($i=0;$i<$a;$i++){
                                        ...
                                        <td>".$hsl[$i][1]."</td>
                                        <td><a href='detailkamartopsis.php?idk=".ucwords(($hsl[$i][0]))."' class='btn btn-lg btn-outline-primary text-uppercase'>Selengkapnya...</a></td>
                                        </tr>";
                                    }
                                    echo "</tbody></table><hr>";
