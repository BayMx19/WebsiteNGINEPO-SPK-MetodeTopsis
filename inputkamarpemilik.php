...
?>
    ...
    <div class="container">
      ...
      <h1 class="mt-5">Input Kamar Pemilik Hotel</h1>
      <div class="row">
        <div class="col-lg-8">
                    ...
                    <div class="form-group">
                              <?php
                                                ...
                                                while ($datakriteria = mysql_fetch_array($querykriteria))
                                                {
                                                  ...
                                                  <div class="radio">
                                                    <label><input type="radio"  name="kepentingan<?php echo $datakriteria['id_kriteria']; ?>" value="<?php echo $datakriteria['t_kriteria']; ?>"> <?php echo $datakriteria['keterangan']; ?></label>
                                                  </div>
            ...
            <tr>
              ...
              <td><select class="form-control" name="tipe">
                                                ...
                                                <option value="putra">Single</option>
                                                <option value="putri">Twin</option>
                                                <option value="campur">Deluxe</option>
                                            </select></td>
            </tr>
            <tr>
              ...
              <td>
                                                ...
                                                <option value="bulan">1 Hari</option>
                                                <option value="3bulan">3 Hari</option>
                                                <option value="6bulan">6 Hari</option>
                                                <option value="tahun">2 Minggu</option>
            ...
            <tr>
              ...
              <div class="alert alert-danger">
                <strong>Maaf!! Anda harus mengisi biodata pemilik kamar hotel terlebih dahulu</strong>
              </div>
              </div>
