  ...
  <div class="container contentAllCK">
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-md-offset-1 listing-wrapper">
                ...
                <h1 class="listingTitle"><p style="text-align=center;">PENCARIAN HOTEL</p></h1>
...
<script type="text/javascript">
  ...
  <div>
    ...
    <form action="caricustom.php" method="post">
        ...
        <div class="row">
          <div class="col-sm-4">
            <h3 class="panel-title" data-toggle="collapse" data-target="#panelOne" aria-expanded="true">Cari Nama Hotel</h3>
            <input type="text" name="nama" class="form-control"/>
            <br>
            <h3 class="panel-title" data-toggle="collapse" data-target="#panelOne" aria-expanded="true">Cari Tipe Hotel</h3>
            <ul class="list-group">
                    <?php
          ...
          <div class="col-sm-4">
            ...
            <h3 class="panel-title" data-toggle="collapse" data-target="#panelOne" aria-expanded="true">Cari Harga Hotel</h3>
          ...
          <div class="col-sm-4">
            ...
            <h3 class="panel-title" data-toggle="collapse" data-target="#panelOne" aria-expanded="true">Cari Fasilitas Hotel</h3>
