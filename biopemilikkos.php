    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12">
              ...
              <h1 class="mt-5">Biodata Pemilik Hotel</h1>
...
$(document).ready(function(){
    $('form').parsley();
              ...
              <div class="alert alert-info">
                <strong>Info!</strong> Sebelum anda dapat melakukan pengisian kamar hotel, terlebih dahulu harus mengisi biodata pemilik hotel,Terima kasih.
              </div>
...
<form action="" class="form-horizontal" data-toggle="validator" role="form" method="post">
                  ...
                  <div class="form-group">
                      ...
                      <input class="form-control" data-error="Nama Hotel Tidak Boleh Kosong." id="namakos" placeholder="Nama Hotel"  name="namakos" type="text" required />
                      <div class="help-block with-errors"></div>
                  </div>
                  ...
                  <div class="form-group">
                    <input id="btn-fblogin" class="btn btn-danger" type="submit" value="Input Data Pemilik Hotel" />
                  </div>
