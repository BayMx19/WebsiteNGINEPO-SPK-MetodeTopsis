      ...
      <?php
                  ...
                  $option = array();
                   ...
                   if (isset($_POST['keamanan']) && !empty($_POST['keamanan'])) {
                      $option[] = 'keamananhotel.id_keamanan = "'.$_POST['keamanan'].'"';
                  }  

                  if (isset($_POST['kenyamanan']) && !empty($_POST['kenyamanan'])) {
                      $option[] = 'kenyamananhotel.id_kenyamanan = "'.$_POST['kenyamanan'].'"';
                  } 

                  if (isset($_POST['kebersihan']) && !empty($_POST['kebersihan'])) {
                      $option[] = 'kebersihanhotel.id_kebersihan = "'.$_POST['kebersihan'].'"';
                  }

                  if (isset($_POST['nama']) && !empty($_POST['nama'])) {
                      $option[] = 'pemilik.nama_hotel LIKE "%' . $_POST['nama'] . '%"';
                  }
                  ...
                  if (isset($_POST['fasilitas'])) {
                      ...
                      $option[] = 'fasilitashotel.id_fasilitas IN (' . $in_fasilitas . ')';
                  }
